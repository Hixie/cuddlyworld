...
uses
   sysutils, storable, matcher, physics, player, locations, things, world, stairs, testmechanics;
...
procedure TestMechanics6();
   ...
   begin
      ...
      RunCommand('up', ['Top Room', 'This is the room at the top of the stairs. Stairs lead down to the Bottom room.']);
      ...
      RunCommand('u', ['Top Room', 'This is the room at the top of the stairs. Stairs lead down to the Bottom room.']);
      ...
      RunCommand('u', ['(past a bag of holding)', 'Top Room', 'This is the room at the top of the stairs. Stairs lead down to the Bottom room.']);
      ...
      RunCommand('up', ['(past a bag of holding)', 'Top Room', 'This is the room at the top of the stairs. Stairs lead down to the Bottom room.']);
      ...
      RunCommand('take stairs', ['(past a bag of holding)', 'Top Room', 'This is the room at the top of the stairs. Stairs lead down to the Bottom room.']);
   end;
